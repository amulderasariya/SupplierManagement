...
const seedUsers = async () => {
	...
	const req = {
		body: { email: "thri@gmail.com", password: "Babloo@1", role: "SUPPLIER" },
	};
	...
	await register(
		{
			body: { email: "user5@gmail.com", password: "Babloo@1", role: "OWNER" },
		},
		res
	);
	await register(
		{
			body: { email: "user6@gmail.com", password: "Babloo@1", role: "OWNER" },
		},
		res
	);
	await register(
		{
			body: { email: "user7@gmail.com", password: "Babloo@1", role: "OWNER" },
		},
		res
	);
	await register(
		{
			body: { email: "user8@gmail.com", password: "Babloo@1", role: "OWNER" },
		},
		res
	);
	await register(
		{
			body: { email: "user9@gmail.com", password: "Babloo@1", role: "OWNER" },
		},
		res
	);
};
